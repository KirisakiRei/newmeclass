...
const envSchema = z.object({
  ...
  AUTH_REGISTER_OTP_TTL_MINUTES: z.string().optional(),
  AUTH_REGISTER_OTP_MAX_ATTEMPTS: z.string().optional(),
  AUTH_REGISTER_RESEND_COOLDOWN_SECONDS: z.string().optional(),
